...
- La resolución del raster (440×280 celdas) está pensada para que las fronteras se vean nítidas incluso haciendo zoom de cerca a una sola división; generar el mapa sigue siendo barato porque solo se hace una vez por partida, no en cada frame.
