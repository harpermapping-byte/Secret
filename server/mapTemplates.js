 ...
 */
function generateMap({ tileCount, factionCount, mode, mapKey, dungeonsEnabled, wondersEnabled }) {
  ...
  const decorations = placeDecorations(cellTileIds, currentSource.cols, currentSource.rows, tileCount, dungeonCount, wonderCount);
 ...
 */
function placeDecorations(cellTileIds, cols, rows, tileCount, dungeonCount = 0, wonderCount = 0) {
  const decorations = [];
  const placedAll = [];
