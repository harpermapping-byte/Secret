...
**Pendiente de esta misma petición, para los siguientes lotes** (el pedido original venía con mucho más — se separó en lotes para poder verificar cada pieza, en vez de un cambio enorme sin probar): movimiento en cono desincronizado para las tropas, quitar el tinte semitransparente del sprite del jugador y poner un puntito de color de facción junto al nombre, y recortar la lista de comandos a solo nombre + explicación breve (la explicación larga se queda en el modal de ayuda). Ver secciones 22, 23 y 24 para lo ya resuelto de esta lista (generación de estructuras por probabilidad, anti-solape, tamaño/dispersión de edificios de tropa, guarnición/aldeanos paseando, capitales de facción, y el modelo de daño en cascada por tipo de tropa).
